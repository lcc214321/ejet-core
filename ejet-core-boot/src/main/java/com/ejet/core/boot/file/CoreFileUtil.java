...
public class CoreFileUtil {
	 ...
	 * @return BladeFile
	 */
	public static CoreFile getFile(MultipartFile file) {
	 ...
	 * @return BladeFile
	 */
	public static CoreFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static CoreFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new CoreFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return BladeFile
	 */
	public static List<CoreFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BladeFile
	 */
	public static List<CoreFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static List<CoreFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<CoreFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new CoreFile(file, dir, path, virtualPath));
		}
		return list;
	}
