package com.ejet.core.kernel.web.jackson;

import com.ejet.core.kernel.web.utils.DateTimeUtil;
 ...
 * @author L.cm
 */
public class CoJavaTimeModule extends SimpleModule {

	public CoJavaTimeModule() {
