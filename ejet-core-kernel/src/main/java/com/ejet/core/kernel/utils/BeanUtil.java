...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	/**
	 * 获取Bean的属性
	 * @param bean DataSourceBean
	 * @param propertyName 属性名
	 * @return 属性值
	 */
	public static Object getProperty(Object bean, String propertyName) {
		Assert.notNull(bean, "DataSourceBean Could not null");
	...
	/**
	 * Copy the property values of the given source DataSourceBean into the target class.
	 * <p>Note: The source and target classes do not have to match or even be derived
	 * from each other, as long as the properties match. Any DataSourceBean properties that the
	 * source DataSourceBean exposes but the target DataSourceBean does not will silently be ignored.
	 * <p>This is just a convenience method. For more complex transfer needs,
	 * @param source the source DataSourceBean
	 * @param target the target DataSourceBean class
	 * @param <T> 泛型标记
