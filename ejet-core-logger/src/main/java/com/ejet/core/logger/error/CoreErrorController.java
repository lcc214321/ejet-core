 ...
 * 更改html请求异常为ajax
 */
public class CoreErrorController extends BasicErrorController {

	public CoreErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
