 ...
 */
package com.ejet.core.logger.logger;

import com.ejet.core.logger.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class CoreLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": CoreLogger init success!");
	}
